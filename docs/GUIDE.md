...
> **Welcome to Service-Track Week 3, Task 3!**
...
| `src/reportBuilder.py` | Main source code - **has bugs to fix** |
| `src/salesAggregator.py` | Supporting code - **may also have bugs** |
| `tests/test_salesAggregator.py` | Test file - **add your tests here** |
...
### Bug #1 - in `src/reportBuilder.py` (around line 14)
**What's wrong:** - see PR comments."""

**How to find it:** Open `src/reportBuilder.py` and look for the `BUG:` comment near line 14. Read the comment carefully - it describes exactly what's broken.
...
### Bug #2 - in `src/reportBuilder.py` (around line 18)
**What's wrong:** described in TICKET.md

**How to find it:** Open `src/reportBuilder.py` and look for the `BUG:` comment near line 18. Read the comment carefully - it describes exactly what's broken.

**Hint:** Think about what the correct behavior should be (described in `TICKET.md` under Requirements), then compare it to what the code actually does.

### Bug #3 - in `src/reportBuilder.py` (around line 23)
**What's wrong:** in logic."""

**How to find it:** Open `src/reportBuilder.py` and look for the `BUG:` comment near line 23. Read the comment carefully - it describes exactly what's broken.

**Hint:** Think about what the correct behavior should be (described in `TICKET.md` under Requirements), then compare it to what the code actually does.

### Bug #4 - in `src/salesAggregator.py` (around line 14)
**What's wrong:** - see PR comments."""

**How to find it:** Open `src/salesAggregator.py` and look for the `BUG:` comment near line 14. Read the comment carefully - it describes exactly what's broken.

**Hint:** Think about what the correct behavior should be (described in `TICKET.md` under Requirements), then compare it to what the code actually does.

### Bug #5 - in `src/salesAggregator.py` (around line 18)
**What's wrong:** described in TICKET.md

**How to find it:** Open `src/salesAggregator.py` and look for the `BUG:` comment near line 18. Read the comment carefully - it describes exactly what's broken.

**Hint:** Think about what the correct behavior should be (described in `TICKET.md` under Requirements), then compare it to what the code actually does.

### Bug #6 - in `src/salesAggregator.py` (around line 23)
**What's wrong:** in logic."""

**How to find it:** Open `src/salesAggregator.py` and look for the `BUG:` comment near line 23. Read the comment carefully - it describes exactly what's broken.
